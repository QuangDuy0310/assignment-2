...
def search_product(driver, product_name):
    ...
    try:
        search_results = driver.find_elements(By.CSS_SELECTOR, "row product-list")
        product_found = False
        
        # Kiểm tra xem tên sản phẩm có xuất hiện trong các kết quả tìm kiếm
        ...
        if product_found:
            print(f"Có sản phẩm: {product_name}")
        else:
            print(f"Không thấy sản phẩm cần tìm: {product_name}")
